...
def chunks_mount(chunk, of_dir, i, block_size):
    os.system('dd if={}{} of={} seek={} bs={} count=1'.format(CHUNKS_DIR, chunk, of_dir, i, block_size * 1024))
...
def main():
    ...
    for numb in range(int(description[1])):
        ...
        extract(chunk_name)
        chunks_mount(chunk_name, OF_DIR, numb, BLOCK_SIZE)
